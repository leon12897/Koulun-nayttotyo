...
public class tekstiPeli {
	...
	JFrame ikkuna;
	//alusta johon voi laittaa useita asioita, ikkuna on alimmainen kerro, Containerin sisältö toinen kerros ikkunan päälle
	Container con;
...
public void END() {
	...
	public void Close() {
		// tämä toiminto sulkee ohjelman kun pelaaja valitsee lopettavansa.
		//minun oiti toteuttaa tämä omana metodina, koska suoraan casessa se aiheutti molemmat napit sulkemaan pelin
		System.exit(0);
	}
